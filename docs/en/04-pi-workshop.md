...
This is a manual exercise protocol. Pi has not been installed or executed in this repository. Follow the [official documentation entry](https://pi.dev/) for installation and provider setup, and record the exact version you use. No unverified package spellings or authentication commands are supplied here.
...
## 1. Establish an isolated starting point
...
## When this exercise is insufficient
